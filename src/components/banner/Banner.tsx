...
const Banner = () => {
  return (
    <div className="relative bg-gray-900 overflow-hidden flex justify-center items-center flex-wrap">
      <div className="relative z-10 lg:max-w-2xl lg:w-full mt-20 sm:mt-20 md:mt-0 lg:mt-0 xl:mt-0">
        <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
          <div className={classes["container-text"]}>
            ...
            <Button className="mt-5 flex items-center justify-center border border-transparent text-base font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 md:py-4 md:text-lg md:px-10">
              Ver catálogo
            </Button>
          </div>
        </main>
